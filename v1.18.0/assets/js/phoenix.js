(function (global, factory) {
  ...
  const flatpickrInit = () => {
    ...
    document.querySelectorAll(".datetimepicker").forEach((t) => {
      ...
      window.flatpickr(t, {
        ...
        onDayCreate: (e, t, o, s) => {
          (5 !== s.dateObj.getDay() && 6 !== s.dateObj.getDay()) ||
  ...
  const flightMapInit = () => {
      if (document.querySelector("#flightMap")) {
        ...
        e.addEventListener("click", () => n.zoomIn()),
          t.addEventListener("click", () => n.zoomOut()),
          o.addEventListener("click", () =>
            n.getContainer().requestFullscreen()
          );
        const a = [-61.100583, 5.044713],
          ...
          s = {
            ...
            features: [
              {
                type: "Feature",
                geometry: { type: "LineString", coordinates: [a, i] },
              },
            ],
          },
          c = {
            ...
            features: [
              {
                type: "Feature",
                geometry: { type: "LineString", coordinates: [i, l] },
              },
            ],
          };
        let d = 1;
        ({
          ...
          (t.className = `marker-${d}`),
            new window.mapboxgl.Marker(t)
            ...
            n.addSource("route", { type: "geojson", data: s.features[0] }),
              ...
              n.addLayer({
                ...
                paint: {
                  "line-width": 2,
                  "line-color":
                    "dark" === getItemFromStore("phoenixTheme")
                      ? getColor("primary")
              ...
              n.addLayer({
                ...
                source: "route2",
                type: "line",
                paint: { "line-width": 1, "line-color": getColor("warning") },
              });
          });
      }
    },
        ...
        e.forEach(() => {
          ...
          const e = new window.mapboxgl.Map({
            ...
            style: {
              ...
              light: "mapbox://styles/themewagon/clj57pads001701qo25756jtw",
              dark: "mapbox://styles/themewagon/cljzg9juf007x01pk1bepfgew",
            }[window.config.config.phoenixTheme],
            center: [-73.102712, 7.102257],
            zoom: 3.5,
            pitch: 40,
            attributionControl: !1,
          ...
          e.on("load", () => {
            e.addSource("earthquakes", {
              ...
              e.on("click", "clusters", (t) => {
                const o = e.queryRenderedFeatures(t.point, {
                    layers: ["clusters"],
                  }),
                ...
                e.getSource("earthquakes").getClusterExpansionZoom(
                  ...
                  (t, r) => {
                    t ||
                      e.easeTo({ center: o[0].geometry.coordinates, zoom: r });
                  }
                );
              }),
              e.on("click", "unclustered-point", (t) => {
                ...
                for (; Math.abs(t.lngLat.lng - o[0]) > 180; )
                  o[0] += t.lngLat.lng > o[0] ? 360 : -360;
                new window.mapboxgl.Popup()
                  .setLngLat(o)
                  .setHTML(`magnitude: ${r}<br>Was there a tsunami?: ${s}`)
                  .addTo(e);
              }),
            ...
            series: [
              {
                ...
                axisLine: {
                  lineStyle: { width: 4, color: [[1, o("secondary-bg")]] },
                },
                splitLine: { show: !1 },
                axisTick: { show: !1 },
                axisLabel: { show: !1 },
  ...
  const playOnHoverInit = () => {
    const e = document.querySelectorAll("[data-play-on-hover]");
    e &&
      e.forEach((e) => {
